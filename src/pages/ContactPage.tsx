...
const ContactPage = () => {
  return (
    <div className="content">
      <h1>Contact</h1>
      <h2>Legal Notice / Information according to &#xA7; 5 TMG</h2>
      <p>Anke Nagel</p>
      <p>
        Friedrich-Wöhler-Str. 10
        <br />
        16303 Schwedt
        <br />
        Germany
      ...
      <p className="mb-2em">
        E-mail: anntothekay@gmail.com
        <br />
        Discord: <a href="https://discord.gg/gPnCNfWJh2">Annkay's Dragon Den</a>
      </p>
      ...
      <p>
        ...
        or topicality. According to Section 7, paragraph 1 of the TMG
        (Telemediengesetz - German Telemedia Act), we as service providers are
        liable for our content on these pages by general laws. However,
