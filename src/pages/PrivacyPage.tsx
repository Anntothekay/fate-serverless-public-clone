...
const PrivacyPage = () => {
  return (
    <div className="content article">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            "Us" or "Our" in this Agreement) refers to FATE.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Country</strong> refers to: Brandenburg, Germany
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to FATE, accessible from{" "}
            <a
              href="fate.netlify.app"
              target="_blank"
      ...
      <ul>
        <li>By email: anntothekay@gmail.com</li>
      </ul>
    </div>
  );
};
