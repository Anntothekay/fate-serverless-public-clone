...
const TermsAndConditionsPage = () => {
  return (
    <div className="content article">
      ...
      <p>
        <em>updated May 2023</em>
      </p>
      <p>&nbsp;</p>
      <p>Welcome to FATE!</p>
      <p>
        These terms and conditions outline the rules and regulations for the use
        of FATE's Website, located at fate.netlify.app.
      </p>
      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use FATE if you do not agree to take all
      ...
      <p>
        ...
        subject to, prevailing law of de. Any use of the above terminology or
      ...
      <p>
        We employ the use of cookies. By accessing FATE, you agreed to use
        cookies in agreement with the FATE's Privacy Policy.
      </p>
      <p>
      ...
      <p>
        Unless otherwise stated, FATE and/or its licensors own the intellectual
        property rights for all material on FATE. All intellectual property
        rights are reserved. You may access this from FATE for your own personal
        use subjected to restrictions set in these terms and conditions.
      </p>
      <p>You must not:</p>
      <ul>
        <li>Republish material from FATE</li>
        <li>Sell, rent or sub-license material from FATE</li>
        <li>Reproduce, duplicate or copy material from FATE</li>
        <li>Redistribute content from FATE</li>
      </ul>
      <p>
      ...
      <p>
        ...
        exchange opinions and information in certain areas of the website. FATE
        ...
        of FATE,its agents and/or affiliates. Comments reflect the views and
        opinions of the person who post their views and opinions. To the extent
        permitted by applicable laws, FATE shall not be liable for the Comments
      ...
      <p>
        FATE reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant FATE a non-exclusive license to use, reproduce, edit
      ...
      <p>
        ...
        the hyperlink compensates the absence of FATE; and (d) the link is in
      ...
      <p>
        ...
        e-mail to FATE. Please include your name, your organization name,
      ...
      <p>
        No use of FATE's logo or other artwork will be allowed for linking
